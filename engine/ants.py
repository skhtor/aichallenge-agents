...
# This is the official ants.py client library provided by the game server.
# Source: aichallenge/ants/dist/starter_bots/python/ants.py
# SHA-256: af144ce63faabc338d040ae9211c97b2169878a091e7db5e749578975e8fc7f6
# The server injects its own copy at runtime — this local copy is only used
# for local tournament testing. Any modifications will cause mismatches
# between local and server behaviour.
#!/usr/bin/env python
import sys
import traceback
import random
